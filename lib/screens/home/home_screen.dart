                                ...
                                if (data['denuncia'] != null) {
                                  ...
                                  final model = VisitsModel(
                                    ...
                                    city: data['requerimento']['empresa']
                                            ['endereco']['cidade'] ??
                                        '',
                                    neighborhood: data['requerimento']
                                    ...
                                    cnpjOrCpf: data['requerimento']['empresa']
                                            ['cpf_cnpj'] ??
                                        '',
                                    companyEmail: data['requerimento']
                                            ['empresa']['user']['email'] ??
                                        '',
                                  );
                                  return VisitTile(
