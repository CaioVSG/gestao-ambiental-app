              ...
              if (snapshot.hasData) {
                ...
                final addressModel = AddressModel(
                  ...
                  complement: dataList[0]['denuncia']['empresa']['endereco']
                          ['complemento'] ??
                      '',
                  cep: dataList[0]['denuncia']['empresa']['endereco']['cep'],
                );
                final profileModel = Profile(
                    name: dataList[0]['denuncia']['empresa']['user']['name'],
                    email: dataList[0]['denuncia']['empresa']['user']['email'],
                                  ...
                                  onTap: () {
                                    Navigator.push(context,
                                      ...
                                      return DetailsScreen(
                                        ...
                                        creationDate: complaintModel.createdAt,
